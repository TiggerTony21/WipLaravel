...
<head>
    ...
    <link href="<?php echo e(asset('css/stylesgeneracion.css')); ?>" rel="stylesheet"
</head>
<body>
    ...
    <header>
        <nav class="navbar">
            <div class="logo">
                <img src="<?php echo e(asset('image.png')); ?>" alt="Logo Universidad">}
            </div>
            <ul class="nav-links">
    ...
    <main>
        <section class="home-section">
            ...
            <div class="form-qr-container">
                ...
                <form action="<?php echo e(url('guardar-grupo')); ?>" method="POST" id="groupForm"> 
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label for="nombreGrupo">Nombre del Grupo:</label>
                        <input type="text" id="nombreGrupo" name="nombreGrupo" required value="<?php echo e(old('nombreGrupo')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="materia">Materia:</label>
                        <input type="text" id="materia" name="materia" required value="<?php echo e(old('materia')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="fechaClase">Fecha de la Clase:</label>
                        <input type="date" id="fechaClase" name="fechaClase" required value="<?php echo e(old('fechaClase')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="profesor">Profesor:</label>
                        <input type="text" id="profesor" name="profesor" required value="<?php echo e(old('profesor')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="horarioClase">Horario de la Clase: </label>
                        <input type="time" id="horarioClase" name="horarioClase" required value="<?php echo e(old('horarioClase')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="horarioClaseFinal">Horario de Clase Finalizada: </label>
                        <input type="time" id="horarioClaseFinal" name="horarioClaseFinal" required value="<?php echo e(old('horarioClaseFinal')); ?>">
                    </div>
                    <div class="form-group">
                        <label for="horarioRegistro">Horario de Registro Activo: </label>
                        <input type="time" id="horarioRegistro" name="horarioRegistro" required value="<?php echo e(old('horarioRegistro')); ?>">
                    </div>
                ...
                <div class="qr-summary">
                    <div id="qrContainer" class="qr-container" value="<?php echo e(old('qrContainer')); ?>"></div>
                    <p id="qrCodeText"></p>
                </div>
            </div>
        </section>
